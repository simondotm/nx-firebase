...
/** 
 * To check Nx + NodeJS + TS compatibility, use the following link:
 * https://nx.dev/reference/core-api/workspace/documents/nx-nodejs-typescript-version-matrix
 */

/**
 * Default Firebase Node version is derived from the Nx version. Nx 19+ supports
 * Node 20, so we use this as default value, otherwise fallback to Node18.
 */
const nodeVersion = nxMajorVersion >= 18 ? '20' : '18'
